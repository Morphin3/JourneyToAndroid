...
//    protected ImageButton mButton; // Button to expand/collapse
    ...
    protected TextView mTvSuffix;  // TextView to expand/collapse
...
//        }
        ...
        if (mTvSuffix.getVisibility() != View.VISIBLE) {
            return;
        }

        mCollapsed = !mCollapsed;

        mTvSuffix.setText(mCollapsed ? mSuffix : "");
...
//        mButton.setVisibility(View.VISIBLE);
        mTvSuffix.setVisibility(View.VISIBLE);
    ...
    public void setText(@Nullable CharSequence text, @NonNull CharSequence suffix) {
        mRelayout = true;
        mTv.setText(text);
        setVisibility(TextUtils.isEmpty(text) ? View.GONE : View.VISIBLE);
        mSuffix=suffix.toString();
        mTvSuffix.setText(mSuffix);
//        mText = text.toString();
//        String realStirng = text + suffix.toString();
//        SpannableString ss = new SpannableString(realStirng);
...
//        mButton.setOnClickListener(this);
        //modify
        mTvSuffix = (TextView) findViewById(R.id.tv_expand_collapse);
